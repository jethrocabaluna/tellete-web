...
const Button = ({
  ...
  return (
    ...
    >
      {
        loading && (
          <svg className="inline mr-2 w-6 h-6 text-primary-light animate-spin dark:text-primary-dark fill-primary-dark dark:fill-primary" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
